...
var handleConversionRateSparkline = function(id) {
	var options = {
		chart: {
			type: 'line',
			width: 160,
...
var handleStoreSessionSparkline = function(id) {
	var options = {
		chart: {
			type: 'line',
			width: 160,
...
var DashboardV3 = function () {
	...
	return {
		...
		init: function () {
			...
			//invest page
			handleConversionRateSparkline('#invest-sparkline-1');
			...
			handleStoreSessionSparkline('#invest-sparkline-8');

			//balance page
			handleConversionRateSparkline('#balance-sparkline-1');
			handleStoreSessionSparkline('#balance-sparkline-2');

			//trading page
			handleConversionRateSparkline('#trading-sparkline-1');
			...
			handleStoreSessionSparkline('#trading-sparkline-8');
...
$(document).ready(function() {
	DashboardV3.init();
	$("#edit_doc").click(()=>{
		$("#edit_doc").addClass("d-none")
		$("#cancel_edit_doc").removeClass("d-none");
		$(".edit_btn").removeClass("d-none");
	})
	$("#cancel_edit_doc").click(()=>{
		$("#edit_doc").removeClass("d-none")
		$("#cancel_edit_doc").addClass("d-none");
