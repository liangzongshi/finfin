...
var handlePieChart = function(id, label, value, text) {
	var options = {
		chart: {
			height: 365,
			type: 'pie',
...
var ChartApex = function () {
	...
	return {
		//main function
		init: function () {
			//piechart finance page
			var labelPiechart = ['Sumption Fund', 'Education Fund', 'Investment Fund', 'Playing Fund', 'Saving Fund']
			var valuePiechart = [5, 1, 2, 1, 1]
			var textPiechart = 'Assets Fund Distribution'
			handlePieChart('#apex-pie-chart1', labelPiechart, valuePiechart, textPiechart);
			handlePieChart('#apex-pie-chart',labelPiechart, valuePiechart, textPiechart);
			//end finance page
			...
			//piechart balance page
			handlePieChart('#apex-pie-chart2',labelPiechart, valuePiechart, textPiechart);
			//end balance page
